...
export const CONFIG={ database:'https://veruela-89cec-default-rtdb.europe-west1.firebasedatabase.app', path:'/veruela_preparacion_v2', pollMs:3500, mecenasMode:'script' };
